...
try:
    ...
    setup(
        ...
        package_data={"": ["README.md", "LICENSE",'temp.py', 'temp.cmd','BHA_Opener.zip'],"bool_hybrid_array":["*.py","*.pyd","*.c"],"bool_hybrid_array/__pycache__":['*.pyc'],"bool_hybrid_array/int_array":["*"],"bool_hybrid_array":["*"]},
